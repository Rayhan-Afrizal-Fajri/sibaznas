<div
    ...
    <div
        ...
        <div class="flex justify-between items-center border-b pb-3">
            <h2 class="text-lg font-semibold">Edit Pengurus</h2>
            <button
                onclick="closeModal('modal-editPengurus')"
                class="text-gray-500 hover:text-gray-700 text-xl">&times;</button>
        </div>

        <!-- Form -->
        <form
            action="{{ route('pengurus.update', 1) }}"
            method="POST"
            class="mt-4"
            enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <input type="text" name="pengurus_id" hidden id="editPengurusId">
            <!-- Nama -->
            <div class="mb-4">
