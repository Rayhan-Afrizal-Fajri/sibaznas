...
<form action="{{ route('permohonan.tambah-lampiran-pencairan', $detail_permohonan->permohonan_id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div id="modal-tambahLampiranPencairan-{{ $detail_permohonan->permohonan_id }}"
