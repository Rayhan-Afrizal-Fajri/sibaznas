...
@if ($lampiran->isNotEmpty())
    <form action="{{ route('permohonan.update-lampiran', $lampiran->lampiran_id) }}" method="POST"
        enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div id="modal-ubahLampiran-{{ $lampiran->lampiran_id }}"
            ...
            <div class="bg-white p-4 rounded-md shadow-lg sm:w-[672px] max-h-[90vh] custom-scrollbar overflow-y-auto">
                <div class="flex justify-between items-center border-b-[1.5px] border-gray-500">
                    <h2 class="text-sm font-semibold text-gray-800 uppercase">Ubah Lampiran</h2>
                    ...
                    <div class="grid gap-4 mb-4 md:grid-cols-2">
                        <div>
                            ...
                            <input name="keterangan_edit" type="text"
                                ...
                                value="{{ old('keterangan_edit', $lampiran->keterangan) }}">
                        </div>
                        <div>
