    ...
    <div
        ...
        <div class="bg-white p-5 rounded-lg shadow-lg w-96">
            ...
            <div class="flex justify-between items-center border-b pb-2">
                <h2 class="text-lg font-semibold">Tambah Program</h2>
                <button onclick="closeModal('modal-addProgram')" class="text-gray-500 hover:text-gray-700">&times;</button>
            </div>

            <!-- Form -->
            <form action="{{ route('program.store') }}" method="POST" class="mt-4">
                @csrf
                <div class="mb-4">
                    ...
                    <div class="flex justify-end gap-2">
                        <button
                            type="button"
                            onclick="closeModal('modal-addProgram')"
