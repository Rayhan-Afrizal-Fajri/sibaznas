    ...
    <div
        ...
        <div class="bg-white p-5 rounded-lg shadow-lg w-96">
            ...
            <div class="flex justify-between items-center border-b pb-2">
                ...
                <button onclick="closeModal('modal-addJabatan')" class="text-gray-500 hover:text-gray-700">&times;</button>
            </div>

            <!-- Form -->
            <form action="{{ route('jabatan.store') }}" method="POST" class="mt-4">
                @csrf
                <input type="text" name="divisi_id" id="jabatanDivisiId" hidden>
                <div class="mb-4">
                ...
                <div class="flex justify-end gap-2">
                    <button
                        type="button"
                        onclick="closeModal('modal-addJabatan')"
