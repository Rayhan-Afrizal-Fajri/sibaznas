                    ...
                    <div class="flex gap-2">
                        <div id="editDeleteProgramContainer" class="hidden flex gap-2">
                            ...
                            <form id="deleteProgramForm" method="POST" action="">
                                ...
                                <button type="submit"onclick="return confirm('Apakah Anda yakin ingin menghapus program ini?')" class="bg-red-700 px-3 py-2 text-xs font-semibold text-white rounded-lg">
                                    Hapus
                                </button>
                            </form>
                        </div>
    ...
    <script>
        $(document).ready(function () {
            $('.program-row').click(function () {
                ...
                // Setel action form untuk menghapus program
                $("#deleteProgramForm").attr("action", "/program/" + programId);

                // Menampilkan ID program dan nama program untuk modal tambah sub program
                $("#sub_program-programIdEdit").val(programId);
                $("#sub_program-programNameEdit").val(programName);

                //menampilkan id program dan nama program untuk modal edit program
                ...
                // Tampilkan tabel sub program dan sembunyikan label
                $('.subProgramTable').removeClass("hidden");
                $('.subProgramLabel').addClass("hidden");

                // Panggil AJAX untuk mengambil data sub-program
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        subProgramRow.empty(); // Hapus isi table sebelumnya
                                    ...
                                    1}</td>
                                        <td class="px-2 text-center py-4 flex justify-between items-center">
                                            ...
                                            <div class="flex items-center gap-2 px-4">
                                                <button data-id="${sub.sub_program_id}" class="editSubProgram">
            ...
            // // Event untuk hapus program
            // $("#deleteProgram").click(function () {
            //     var programId = $(this).attr("data-id");

            //     // if (confirm("Apakah Anda yakin ingin menghapus program ini?")) {
            //     //     $.ajax({
            //     //         url: "/program/" + programId, // Sesuai dengan resource route
            //     //         type: "DELETE",
            //     //         data: {
            ...
            //     //         },
            //     //         error: function () {
            //     //             alert("Gagal menghapus program. Coba lagi!");
            //     //         }
            //     //     });
            //     // }
            // });

            // Event untuk hapus sub program
            // $(document).on("click", ".deleteSubProgram", function () {
            //     var subProgramId = $(this).data("id");

            //     if (confirm("Apakah Anda yakin ingin menghapus sub program ini?")) {
            //         $.ajax({
            //             url: "/sub_program/" + subProgramId, // Sesuai dengan resource route
            //             type: "DELETE",
            //             data: {
            //                 _token: $('meta[name="csrf-token"]').attr("content") // Kirim CSRF token
            //             },
            ...
            //             },
            //             error: function () {
            //                 alert("Gagal menghapus sub program. Coba lagi!");
            //             }
            //         });
            //     }
            // });
