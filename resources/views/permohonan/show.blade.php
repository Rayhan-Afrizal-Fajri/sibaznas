<x-app-layout>
    ...
    <nav
        ...
        <button
            ...
            id="persetujuan-atasan-item"
            aria-selected="false"
            data-hs-tab="#persetujuan-atasan"
        ...
        <button
            type="button"
            class="hs-tab-active:font-semibold rounded-t-md border-b border-gray-200 hs-tab-active:border-gray-200 hs-tab-active:border-t hs-tab-active:border-l hs-tab-active:border-r hs-tab-active:border-[#00593b] hs-tab-active:border-b-transparent hs-tab-active:text-blue-600 py-2 px-1 inline-flex items-center gap-x-2 text-xs whitespace-nowrap text-gray-500 hover:text-blue-600 focus:outline-none focus:text-blue-600 disabled:opacity-50 disabled:pointer-events-none"
            id="pencairan-keuangan-item"
            aria-selected="false"
            data-hs-tab="#pencairan-keuangan"
    ...
    <div class="mt-3">
        <div id="permohonan" role="tabpanel" aria-labelledby="permohonan-item">
            <div class="flex flex-col gap-4">
                <div
                    class="w-full bg-white shadow px-3 pt-2 pb-3 border border-gray-200 rounded-md">
                    <span
                        class="inline-flex items-center gap-x-1.5 py-0.5 px-1 rounded-[4px] text-[9px] font-medium bg-[#00593b] text-white">
                        Permohonan Selesai Diinput FO
                    </span>
                    <span
                        class="inline-flex items-center gap-x-1.5 py-0.5 px-1 rounded-[4px] text-[9px] font-medium bg-[#00593b] text-white">
                    ...
                    <span
                        class="inline-flex items-center gap-x-1.5 py-0.5 px-1 rounded-[4px] text-[9px] font-medium bg-yellow-500 text-white">
                        Belum Dicairkan
                    </span>
                            ...
                            <table class="w-100 sm:min-w-full text-[9px] border border-gray-300 rounded-lg">
                                <tbody class="text-[9px] sm:text-xs text-gray-700 bg-white text-left">
                                    <tr>
                                        ...
                                        <td class="px-2 py-3 border font-medium">13/E-DISDAY/INDIVIDU/II/2025</td>
                                    </tr>
                                    <tr>
                                        <td class="px-2 py-3 border font-bold">Tanggal Permohonan</td>
                                        <td class="px-2 py-3 border font-medium">Selasa ,13 Februari 2025</td>
                                    </tr>
                                    <tr>
                                        <td class="px-2 py-3 border font-bold">Data Pemohon</td>
                                        <td class="px-2 py-3 border font-medium">
                                            <div>
                                                <span class="text-white px-1 py-[1px] bg-[#00593b] rounded-[3px]">Individu</span>
                                                <p class="font-bold mt-1">Ferriyan Ilyasa</p>
                                                <p class="font-medium mt-1">0895392167815</p>
                                                <p class="font-medium mt-1">Jalan Ir. H. Juanda No.236 RT 002 RW 006 Kel.
                                                    Lomanis, Kec. Cilacap Tengah, Kab. Cilacap</p>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="px-2 py-3 border font-bold">Nominal</td>
                                        <td class="px-2 py-3 border font-medium">Rp. 500.000</td>
                                    </tr>
                                    <tr>
                                        <td class="px-2 py-3 border font-bold">Bentuk</td>
                                        <td class="px-2 py-3 border font-medium">
                                            <span class="text-white px-1 py-[1px] bg-[#00593b] rounded-[3px]">Uang Tunai</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="px-2 py-3 border font-bold">Asnaf</td>
                                        <td class="px-2 py-3 border font-medium">Miskin</td>
                                    </tr>
                                    <tr>
                                        <td class="px-2 py-3 border font-bold">Program & Sub Program</td>
                                        <td class="px-2 py-3 border font-medium">
                                            <p class="font-bold">CILACAP CERDAS (PENDIDIKAN)</p>
                                            <p class="font-medium">1.1 Bantuan Biaya Pendidikan</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="px-2 py-3 border font-bold">Keterangan</td>
                                        <td class="px-2 py-3 border font-medium">Bantuan biaya pendidikan pembayaran SPP</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                            ...
                            <table class="w-100 sm:min-w-full text-[9px] border border-gray-300 rounded-lg">
                                <tbody class="text-[9px] sm:text-xs text-gray-700 bg-white text-left">
                                    <tr>
                                        ...
                                        <td class="px-2 py-3 border font-medium">
                                            <a href="#" target="_blank" class="text-blue hover:text-blue-500">Permohonan Bantuan.pdf</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="px-2 py-3 border font-bold">Nomor Surat</td>
                                        <td class="px-2 py-3 border font-medium">001/Permohonan</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-2 py-3 border font-medium">Kamis, 15 Februari 2025<i>(13:53:11)</i>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <table class="w-100 sm:min-w-full text-[9px] text-left text-gray-500 border border-gray-300 shadow-md rounded-lg">
                                    ...
                                    <tbody>
                                        <tr class="bg-white border-b text-xs">
                                            ...
                                            <td class="px-2 text-left border">1</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
        ...
        <div
            id="persetujuan-atasan"
            class="hidden"
            role="tabpanel"
            aria-labelledby="persetujuan-atasan-item">
            <div
                class="w-full bg-white shadow px-2 pt-4 pb-3 border border-gray-200 rounded-lg mb-8">
                cek
            </div>
        </div>
        ...
        <div
            id="pencairan-keuangan"
            class="hidden"
            role="tabpanel"
            aria-labelledby="pencairan-keuangan-item">
            <div
                class="w-full bg-white shadow px-3 pt-2 pb-3 border border-gray-200 rounded-md mb-8">
                <span
                    class="inline-flex items-center gap-x-1.5 py-0.5 px-1 rounded-[4px] text-[9px] font-medium bg-[#00593b] text-white">
                    Permohonan Selesai Diinput FO
                </span>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="m-1 hs-dropdown [--trigger:hover] relative inline-flex">
                        <button
                            id="hs-dropdown-hover-event"
                            type="button"
                            class="hs-dropdown-toggle py-1 px-1 inline-flex items-center gap-x-2 text-xs font-medium rounded-md border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none"
                            aria-haspopup="menu"
                            aria-expanded="false"
                            aria-label="Dropdown">
                            Respon
