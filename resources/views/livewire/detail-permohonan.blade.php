<div>
    ...
    <div class="mt-3">
        ...
        <div wire:ignore.self id="survey" class="hidden" role="tabpanel" aria-labelledby="survey-item">
            @include('detail_permohonan.tab_v3')
        </div>

        <div wire:ignore.self id="pencairan-keuangan" class="hidden" role="tabpanel" aria-labelledby="pencairan-keuangan-item">
            @include('detail_permohonan.tab_v4')
        </div>


        <div wire:ignore.self id="lpj-ba" class="hidden" role="tabpanel" aria-labelledby="lpj-ba-item">
