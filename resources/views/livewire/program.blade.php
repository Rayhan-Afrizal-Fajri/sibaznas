{{-- <div class="flex flex-col gap-2">
    ...
    <div
        ...
        <a href="/get-sub-program/{{ $programs->first()->program_id }}">test</a>
    </div>
    <div class="flex justify-between items-start gap-4">
        <div
            ...
            <table id="myTable" class="w-100 sm:min-w-full text-sm text-left text-gray-500 border border-gray-300 shadow-md rounded-lg">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b cursor-pointer program-row" data-id="{{ $p->program_id }}">
                        <td class="px-2 text-center py-4 border">{{ $index + 1 }}</td>
                        <td class="px-2 text-center py-4 border">{{ $p->program }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
        ...
        <div class="w-2/3 bg-white p-4 flex flex-col items-center justify-center gap-2">
            ...
            class="w-100 sm:min-w-full text-sm text-left text-gray-500 border border-gray-300 shadow-md rounded-lg">
                ...
                <tbody id="subProgramTable">
                    <tr>
                        <td colspan="2" class="text-center py-4">Pilih program terlebih dahulu</td>
                    </tr>
                </tbody>
            </table>
        </div>
